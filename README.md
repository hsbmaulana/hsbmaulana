...
I am a technology enthusiast open to all fields related to technology and energetic to tackle network, devops, cybersecurity, and the world of Industry 5.0. With proven track record in managing various projects, I bring abundant experience and expertise to the team. Additionally, I am a keen observer of financial growth, trading, investing, and entrepreneurship. My skills include assertive communication, self-direction, interpersonal/collaborative-contribution skills, and technical skills in optimizing technopreneurship products to be high-quality, fast, and secure. This includes infrastructure incident monitoring/reporting (Unix Sysadmin), data-driven processes (ETL-crawling/scraping, analysis, AI/ML/DL), software development life cycle (eventlistener-driven, MVC-driven, domain design-driven, refactor), and automation (test-driven development, CI/CD/CD, isolation, orchestration). <br />
